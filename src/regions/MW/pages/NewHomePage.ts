 ...
 * Covers the redesigned Betway MW homepage: header, navigation bar and hero banner,
 ...
 * independently verified against MW's own site.
 */
export class NewHomePage extends HeaderPage {
    ...
    // ── Navigation / setup ───────────────────────────────────────────────────
    async gotoHome() {
        await this.page.goto('https://www.betway.mw/', { waitUntil: 'domcontentloaded' });
    ...
    async verifyTitleAndUrl() {
        await expect(this.page).toHaveURL('https://www.betway.mw/');
