...
import { OddsSelectionAbove, LiveOddsSelection, DrawNoBetOddsSelection, EsportsOddsSelection } from '../commonflows/OddSelection';
...
export class BetSaverPage {
    ...
    async goto() {
        await this.page.goto('https://www.betway.mw/sport/soccer');
    ...
    async navigateToMyBets() {
        await this.page.goto('https://www.betway.co.mw/sport/soccer/upcoming?account=my-bets');
        await this.page.waitForLoadState('domcontentloaded');
    }

    async outrightsSelection() {
        await this.page.goto('https://www.betway.co.mw/sport/football/outrights');
        await this.page.waitForTimeout(2000);
    ...
    async clickBookingCode() {
        await this.page.goto('https://www.betway.co.mw/sport/soccer');
        await this.page.waitForTimeout(1000);
