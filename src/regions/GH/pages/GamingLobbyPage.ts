...
export class GamingLobbyPage extends HeaderPage {
    ...
    constructor(page: Page) {
        ...
        this.locatorsRegistry = {
            ...
            promotionsInCasinoGH: getLocator(this.page, configs['promotionsInCasinoGH']),
            ...
            promotionsInBetGamesGH: getLocator(this.page, configs['promotionsInBetGamesGH']),
            ...
            promotionsInVirtualsGH: getLocator(this.page, configs['promotionsInVirtualsGH']),
    ...
    async clickVisiblePromotion(promoKey: string) {
        ...
        await promo.first().scrollIntoViewIfNeeded(); // add this
