 ...
 * Covers the redesigned Betway TZ homepage: header, navigation bar and hero banner,
 ...
 * independently verified against TZ's own site.
 */
export class NewHomePage extends HeaderPage {
    ...
    // ── Navigation / setup ───────────────────────────────────────────────────
    async gotoHome() {
        await this.page.goto('https://en.betway.co.tz/', { waitUntil: 'domcontentloaded' });
