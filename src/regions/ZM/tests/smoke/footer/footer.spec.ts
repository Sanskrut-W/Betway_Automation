...
test.describe('Footer Module Tests', () => {
    ...
    test('T32 b -Verify functionality of "Betting Rules" at footer section', async ({ homePage }, testInfo) => {
        ...
        await expect(newPage).toHaveURL('https://cms1.gmgamingsystems.com/medialibraries/content.gmgamingsystems.com/Synapse/Betting%20rules/BettingRules_ZM_en.pdf');
...
// npx playwright test src/regions/ZM/tests/smoke/footer/footer.spec.ts --config=playwright.ZM.config.ts --headed
// 2.allure generate allure-results --clean -o allure-report
// 3.allure open src/regions/ZM/reports/allure-report
