 ...
 * Covers the redesigned Betway ZM homepage: header, navigation bar and hero banner,
 ...
 * independently verified against ZM's own site.
 */
export class NewHomePage extends HeaderPage {
    ...
    // ── Navigation / setup ───────────────────────────────────────────────────
    async gotoHome() {
        await this.page.goto('https://www.betway.co.zm/', { waitUntil: 'domcontentloaded' });
    ...
    async verifyTitleAndUrl() {
        await expect(this.page).toHaveURL('https://www.betway.co.zm/');
