...
test.describe('Header Module Tests', () => {
    ...
    test('7-Verify country code +234 is visible on Homepage', async ({ headerPage }, testInfo) => {
    ...
    test('28-Verify that N currency in balance field is displayed on the home page of Betway application', async ({ headerPage }, testInfo) => {
    ...
    test('31-Verify that N currency in free bet field is displayed on the home page of Betway application', async ({ headerPage }, testInfo) => {
    ...
    test('33-Verify that Betway Rewards field is displayed on the home page of Betway application', async ({ headerPage }, testInfo) => {
        await headerPage.Login();
    ...
    // Skipped for NG: "Casino Bonus" was renamed to "Betway Rewards", which shows a points value
    // (icon + number, e.g. "2.25") with no currency letter — there's no "R"/"N" to verify here.
