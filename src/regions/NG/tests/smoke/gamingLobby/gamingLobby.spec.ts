...
test.describe('GamingLobby Tests', () => {
    ...
    //     await gamingLobbyPage.verifyLoginPopup();
    ...
    //     await gamingLobbyPage.navigateToVertical('casino');
    ...
    test('Casino: T2 Promotions.', async ({ gamingLobbyPage }, testInfo) => {
        await gamingLobbyPage.navigateToVertical('casino');
        await gamingLobbyPage.closePromotionOverlay();
        await gamingLobbyPage.clickVisiblePromotion('promotionsInCasinoNG');
    ...
    test('Casino: T3 Search.', async ({ gamingLobbyPage }, testInfo) => {
        ...
        await gamingLobbyPage.page.waitForTimeout(1000); // Additional wait to ensure UI updates                
    ...
    //     await gamingLobbyPage.navigateToVertical('betGames');
    //     await gamingLobbyPage.clickVisiblePromotion('promotionsInBetGamesNG');
    ...
    //     await gamingLobbyPage.navigateToVertical('virtuals');
    //     await gamingLobbyPage.clickVisiblePromotion('promotionsInVirtualsNG');
