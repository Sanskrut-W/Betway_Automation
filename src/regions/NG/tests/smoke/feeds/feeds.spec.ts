// npx playwright test src/regions/NG/tests/smoke/feeds/feeds.spec.ts --config=playwright.NG.config.ts --headed
...
test.describe('Feeds Tests', () => {
    ...
    test('T1: Verify Betway Feeds icon presence and functionality.', async ({ feedsPage }, testInfo) => {
        await feedsPage.page.waitForLoadState('domcontentloaded');
