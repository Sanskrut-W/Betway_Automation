...
export class HomePage {
    ...
    constructor(page: import('@playwright/test').Page) {
        ...
        this.HomePagelocatorsRegistry = {
            ...
            BetwayApp: getLocator(this.page, configs["BetwayApp"]),
            AffiliateProgram: getLocator(this.page, configs["AffiliateProgram"]),
            ResponsibleGaming: getLocator(this.page, configs["ResponsibleGaming"]),
            PrivacyPolicy: getLocator(this.page, configs["PrivacyPolicy"]),
            Sponsorships: getLocator(this.page, configs["Sponsorships"]),
