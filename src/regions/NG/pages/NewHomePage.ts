 ...
 * Covers the redesigned Betway NG homepage: header, navigation bar and hero banner,
 ...
 * independently verified against NG's own site.
 */
export class NewHomePage extends HeaderPage {
    ...
    // ── Navigation / setup ───────────────────────────────────────────────────
    async gotoHome() {
        await this.page.goto('https://www.betway.com.ng/', { waitUntil: 'domcontentloaded' });
    ...
    async verifyTitleAndUrl() {
        await expect(this.page).toHaveURL('https://www.betway.com.ng/');
