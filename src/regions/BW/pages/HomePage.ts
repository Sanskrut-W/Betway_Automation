...
export class HomePage extends BasePage {
    ...
    constructor(page: import('@playwright/test').Page) {
        ...
        this.HomePagelocatorsRegistry = {
            ...
            BetwayScoresApp: this.page.locator('a[href="/betway-scores-app"]').last(),
    ...
    async verifyBetwayScoresApp() {
        await this.HomePagelocatorsRegistry.BetwayScoresApp.waitFor({ state: 'visible', timeout: 10000 });
        await highlightElements(this.HomePagelocatorsRegistry.BetwayScoresApp);
    }

    async clickBetwayScoresAppLink() {
        await this.HomePagelocatorsRegistry.BetwayScoresApp.click({ force: true });
        await expect(this.page).toHaveURL(/.*betway-scores*/i, { timeout: 15000 });
        await this.page.waitForLoadState('domcontentloaded');
    }
