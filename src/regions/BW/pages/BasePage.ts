...
/**
 * Shared base for every BW page object.
 ...
 * is the same on every page of the site. Derived from the HeaderPage.Login()
 * variant (#header-username / #header-password, default user4). Move them to
 * config later when genericizing across regions.
 */
export class BasePage {
    ...
    constructor(page: Page) {
        ...
        this.baseLoginLocators = {
            mobileNumber: page.locator('#header-username').first(),
            password: page.locator('#header-password').first(),
        };
    }
